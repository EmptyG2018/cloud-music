        ...
        <div class="wrapper">
          ...
          >
            <mu-form-item
              ...
              label="手机号"
              prop="username"
              :rules="phone.usernameRules"
            >
              <mu-text-field
                v-model="phone.validateForm.username"
                prop="username"
              ></mu-text-field>
            </mu-form-item>
            <mu-form-item
              ...
              label="密码"
              prop="password"
              :rules="phone.passwordRules"
            >
              <mu-text-field
                type="password"
                v-model="phone.validateForm.password"
                prop="password"
              ></mu-text-field>
            </mu-form-item>
            <div class="Ptop4">
              <mu-button large full-width color="#A611F4" @click="sendPhone"
                >提交</mu-button
              >
            </div>
          </mu-form>
        ...
        <div class="wrapper">
          ...
          >
            <mu-form-item
              ...
              label="邮箱账号"
              prop="username"
              :rules="email.usernameRules"
            >
              <mu-text-field
                v-model="email.validateForm.username"
                prop="username"
              ></mu-text-field>
            </mu-form-item>
            <mu-form-item
              ...
              label="密码"
              prop="password"
              :rules="email.passwordRules"
            >
              <mu-text-field
                type="password"
                v-model="email.validateForm.password"
                prop="password"
              ></mu-text-field>
            </mu-form-item>
            <div class="Ptop4">
              <mu-button large full-width color="#A611F4" @click="sendEmail"
                >提交</mu-button
              >
            </div>
          </mu-form>
