	...
	<div class='player'>
		...
		<div class="main">
			...
			<div class="music_box play pause">
				<img src="https://p1.music.126.net/RF7mNeqneGi9EBGo4uqUvA==/59373627916982.jpg" />
			</div>
			<div class="controls">
				...
				<div class="controls_row">
					<div class="progress">
						<div class="flex-wrapper">
							<mu-slider @change="setProgress" color="#F45D5D" :max="playing.time.duration" v-model="time" :display-value="false"></mu-slider>
							<div class="info">
								<mu-flex>
									<mu-flex class="flex-demo" justify-content="start" fill>
										{{currentTime}}
